...
http_path = (environment == :production) ? "https://aaf1a18515da0e792f78-c27fdabe952dfc357fe25ebf5c8897ee.ssl.cf5.rackcdn.com/1688/" : "./" 
...
http_images_dir = (environment == :production) ? "" : "img"
generated_images_dir = (environment == :production) ? "output" : "img"
